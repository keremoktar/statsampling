...
handleError = function(e) {
  ...
  link = '<a href="mailto:cocosci-lab@princeton.edu?subject=ERROR in experiment' + '&body=#{encodeURIComponent(message)}">Click here</a>';
  $('#jspsych-target').html(markdown(`# The experiment encountered an error!\n\n${link} to report the error by email. Please describe at what point in the study the error\noccurred, and include the following\n\n${message}\n\nThen click the button below to submit the HIT.\nIf you have trouble submitting the HIT, please\ncontact <cocosci-lab@princeton.edu>\n\n<button id="submit">Submit HIT</button>`));
