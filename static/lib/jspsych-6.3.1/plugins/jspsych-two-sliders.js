...
jsPsych.plugins['two-sliders'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html += "<div>";
    html += '<br><hr /></div>'
    html += '<div><b>You have indicated the following:</b><br><br></div>'
    html += trial.accuracy_feedback_label  + " <b><span id='range-value-0'></span>% </b>chance that " + trial.proposition + ".<br>";
    html += '<br></div>'
    html += trial.accuracy_feedback_label2  + " <b><span id='range_two-value-0'></span>% </b>chance that " + trial.proposition + ".<br>";
    html += "</div>";
    html += "<hr>";
    html += '<div><br><br></div>'
